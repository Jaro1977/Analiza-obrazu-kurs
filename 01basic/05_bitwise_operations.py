...
img = cv2.imread(r'C:\Users\user\PycharmProjects\Analiza-obrazu-kurs-test\view.jpg')
logo = cv2.imread(r'C:\Users\user\PycharmProjects\Analiza-obrazu-kurs-test\python.png')
